...
//         try {
//             $companyId = $this->permissionService->getEffectiveCompanyId($user);
//             $trainers = $this->trainerService->getAllForCompany($companyId);
...
//             $trainer = $this->trainerService->createTrainer($dto);
...
//                 $restrictedTrainers = $this->permissionService->getRestrictedValues(
//                     $user->user_id,
//                     $companyId,
//                     'trainer_'
//                 );

//                 if (in_array($id, $restrictedTrainers)) {
//                     return response()->json([
//                         'success' => false,
//                         'message' => 'غير مصرح لك بتعديل هذا المدرب (قيود العمليات)'
//                     ], 403);
//                 }
//             }

//             $trainer = $this->trainerService->updateTrainer($id, $validated, $companyId);
...
//                     return response()->json([
//                         'success' => false,
//                         'message' => 'غير مصرح لك بحذف هذا المدرب (قيود العمليات)'
//                     ], 403);
//                 }
//             }

//             $deleted = $this->trainerService->deleteTrainer($id, $companyId);
