...
class StoreAwardRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'award_type_id' => [
                'required',
                'integer',
                // exist in constants with type award_type AND (company_id = this company OR company_id = 0 for generic?) 
                // constants are usually company specific in this system context so far.
            ...
            'award_file' => 'required|file|max:5120|mimes:jpeg,png,jpg,gif,svg,pdf,doc,docx', // Max 5MB
        ];
    }
    ...
    public function messages(): array
    {
        return [
            ...
            'award_type_id.required' => 'نوع المكافئة مطلوب',
            'award_type_id.exists' => 'نوع المكافئة المختار غير صالح',
            'award_date.required' => 'تاريخ المكافئة مطلوب',
            'award_file.required' => 'الصورة مطلوبة',
