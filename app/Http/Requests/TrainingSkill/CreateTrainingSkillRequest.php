...
/**
 * @OA\Schema(
 *     schema="CreateTrainingSkillRequest",
 *     type="object",
 *     title="Create Training Skill Request",
 *     description="طلب إنشاء نوع/مهارة تدريب جديدة",
 *     required={"name"},
 *     @OA\Property(
 *         property="name",
 *         type="string",
 *         example="تطوير البرمجيات",
 *         description="اسم نوع/مهارة التدريب"
 *     )
 * )
 */
class CreateTrainingSkillRequest extends FormRequest
{
    /**
