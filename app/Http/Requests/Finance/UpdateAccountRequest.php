 ...
 *     description="طلب تحديث حساب مالي",
 *     @OA\Property(property="account_name", type="string", example="حساب البنك الأهلي - محدث", description="اسم الحساب"),
 *     @OA\Property(property="account_number", type="string", example="SA1234567890", description="رقم الحساب البنكي"),
 *     @OA\Property(property="branch_code", type="string", example="002", description="رمز الفرع"),
 *     @OA\Property(property="bank_branch", type="string", example="فرع جدة", description="فرع البنك")
 * )
 */
