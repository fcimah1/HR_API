 ...
 *     description="طلب تسجيل مصروف جديد",
 ...
 *     @OA\Property(property="entity_type", type="string", example="employee_account", description="نوع الجهة"),
 *     @OA\Property(property="payment_method_id", type="integer", example=1, description="طريقة الدفع"),
 *     @OA\Property(property="reference", type="string", example="EXP-2026-001", description="رقم المرجع"),
 *     @OA\Property(property="description", type="string", example="شراء لوازم مكتبية", description="الوصف"),
