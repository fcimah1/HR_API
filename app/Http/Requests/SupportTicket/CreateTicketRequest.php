 ...
 *         type="string",
 *         example="technical",
 *         description="نوع التذكرة - يقبل: general, technical, billing, subscription, other أو عام, تقني, فواتير, اشتراك, أخرى أو 0-4"
 *     ),
 *     @OA\Property(
 *         property="priority",
 *         type="string",
 ...
 *         type="string",
 *         maxLength=5000,
 *         example="لا أستطيع تسجيل الدخول للنظام",
...
class CreateTicketRequest extends FormRequest
{
    ...
    protected function prepareForValidation(): void
    {
        ...
        if ($this->has('category')) {
            ...
            // دعم الإرسال بالرقم مباشرة
            $categoryInput = $this->input('category_id');
            if (is_numeric($categoryInput)) {
                $data['category_id'] = (int) $categoryInput;
            } else {
    ...
    public function rules(): array
    {
        return [
            ...
            'category_id' => ['required', 'integer', 'in:' . implode(',', array_column(TicketCategoryEnum::cases(), 'value'))],
    ...
    public function messages(): array
    {
        ...
        return [
            ...
            'category_id.required' => 'نوع التذكرة مطلوب. القيم المقبولة: ' . $acceptedCategories,
    ...
    protected function failedValidation(Validator $validator): void
    {
        throw new HttpResponseException(response()->json([
            ...
            'accepted_values' => [
                'category' => TicketCategoryEnum::getAcceptedNames(),
                'priority' => TicketPriorityEnum::getAcceptedNames(),
            ],
        ], 422));
    }
}
