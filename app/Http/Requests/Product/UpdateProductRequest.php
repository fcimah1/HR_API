 ...
 *     required={"product_name", "warehouse_id", "category_id", "purchase_price", "retail_price", "expiration_date", "product_sku"},
 *     @OA\Property(property="product_name", example="Product Name", type="string", maxLength=255),
...
class UpdateProductRequest extends FormRequest
{
        ...
        return [
            'product_name' => [
                ...
                Rule::unique('ci_stock_products', 'product_name')
                    ...
                    ->ignore($this->route('id'), 'product_id')
            ],
    ...
    public function messages(): array
    {
        return [
            ...
            'product_image.mimes' => 'يجب أن يكون الملف صورة من نوع jpeg,png,jpg,gif',
            'product_image.max' => 'يجب أن لا يتجاوز الملف حجم 2048 كيلوبايت',
