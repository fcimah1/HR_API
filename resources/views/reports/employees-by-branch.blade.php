...
@section('title', 'تقرير الموظفين حسب الفرع')

@section('content')
<h2 style="text-align: center; margin-bottom: 15px;">تقرير الموظفين حسب الفرع</h2>
...
<table>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>{{ $record->designation->designation_name ?? '-' }}</td>
